...
namespace VARLab.RespiratoryTherapy
{
    ...
    public class LearnerSessionHandler : MonoBehaviour
    {
        ...
        public bool IsFirstTimeUser { get; private set; } = false;
        ...
        /// <summary>
        /// Updates the user's first-time status based on the provided value.
        /// </summary>
        /// <param name="newStatus">A boolean value indicating the user's current status: 
        /// pass 'true' if the user is not a first-time user, 'false' if the user is.</param>
        public void SetUserStatus(bool newStatus)
        {
            IsFirstTimeUser = !newStatus;
        }
